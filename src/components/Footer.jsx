                  ...
                  <div className="content">
                    <ul className="lab-ul office-address">
                      {ItemList.map((val, index) => (
                        <li key={index}>
                          <a href="#" className={val.iconName}></a>
                          {val.text}
                        </li>
                      ))}
                    </ul>
      ...
      {/* footer bottom */}
        <div className="footer-bottom padding-tb">
            ...
            <div className="section-wrapper">
                <p>&copy; 2023 <Link to="/">Shop Cart</Link>Designed by <a href="/" target="_blank" rel="noopener noreferrer">PAPA BN</a></p>
                <div className="footer-bottom-list">
                {footerbottomList.map((val, index) => (
                
                    <a href={"#"} key={index}>{val.text}</a>
                ))}
                </div>
            </div>
            </div>
